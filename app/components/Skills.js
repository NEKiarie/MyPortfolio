  ...
  return (
    <motion.div
      className="flex items-center justify-center rounded-full font-semibold
           bg-dark2 text-light py-3 px-6 shadow-dark2 cursor-pointer absolute 
           lg:py-2 lg:px-4 md:text-sm md:py-1.5 md:px-3 dark:text-dark dark:bg-light
           xs:bg-transparent xs:dark:bg-transparent xs:text-light xs:dark:text-dark xs:font-bold"
    ...
    <>
      ...
      dark:bg-circularDark lg:h-[80vh] sm:h-[60vh] xs:h-[50vh]
       ...
       sm:bg-circularLightSm sm:dark:bg-circularDarkSm">
        <motion.div
          className="flex items-center justify-center rounded-full font-semibold
           bg-dark2 text-light p-8 shadow-dark2 cursor-pointer dark:text-dark dark:bg-light lg:p-6
